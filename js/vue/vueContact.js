export function contactApp() {
  const app = Vue.createApp({
    ...
    methods: {
      fetchInterests() {
        fetch(
          "http://localhost:8888/BrothersInArms-Level4-FIP/bia-backend/brothers_in_arms_fip_backend/public/interests"
        )
      ...
      submitForm() {
        ...
        fetch(
          "http://localhost:8888/BrothersInArms-Level4-FIP/bia-backend/brothers_in_arms_fip_backend/public/contacts/add",
          {
            method: "POST",
            headers: {
